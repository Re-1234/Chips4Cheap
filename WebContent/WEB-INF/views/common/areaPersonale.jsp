    ...
    <main class="contenitore-pagina">
        <div class="modulo-centrato">
            ...
            <div id="blocco-azioni-account">
                ...
                <a href="${pageContext.request.contextPath}/common/Logout" class="link-azione" id="link-modifica-cancella">Logout</a> <!-- Pessima scelta fare tutte queste classi per il css, meglio usare i tag -->
            </div>
        </div>
    </main>
